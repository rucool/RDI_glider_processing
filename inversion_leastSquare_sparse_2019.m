...
%  2) Why does Todd use -1 instead of 1 for the glider velocity portion of
%  the G matrix
...
if nbin>nt
    warning('nbin>nt Check dimensions of the inputs are [profiles bins]')
end
